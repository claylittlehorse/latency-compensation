...
local CALL_ERROR_MESSAGE = "Network functions cannot be called with ':'"
...
function Network.createEvent(eventName, isFunction)
	assert(eventName ~= Network, CALL_ERROR_MESSAGE)
...
function Network.hookFunction(functionName, callback)
	assert(functionName ~= Network, CALL_ERROR_MESSAGE)
